...
class Furniture(Product):
    """
    Класс, представляющий мебель, наследующий класс Product.
    """
    def __init__(self, name, price, material, style):
        super().__init__(name, price)
        self.material = material
        self.style = style        

    def get_details(self):
        return f"Мебель: {self.name}, Материал: {self.material}, Стиль: {self.style}, Цена: {self.price} руб."
